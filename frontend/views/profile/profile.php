  ...
  <body>
    <div class="wrapper">
      ...
      <main class="main">
                ...
                <div class="user">
                  <div class="user__section user__section--left">
                    <div class="user__text-info">
                      ...
                      <a class="user__email" href="mailto:emmarossi@gmail.com">emmarossi@gmail.com</a>
                  ...
                  <div class="user__section user__section--right">
                    ...
                    <div class="avatar">
                      <div class="avatar__inner">
                        <!-- <canvas id="graph" width="180" height="180"></canvas> -->
                        <div class="avatar__image bg-image" style="background-image: url('./tmp_images/avatar.jpg');"></div>
                        ...
                        <span class="avatar__element avatar__element--position_top">
                          <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 99 99">
                            <linearGradient id="earth-gradient" x1="0" y1="100%" x2="0" y2="0">
                              <stop offset="<?php echo intval(0.28 * 100); ?>%" stop-color="#551642"></stop>
                              <stop offset="<?php echo intval(0.28 * 100); ?>%" stop-color="#F9C778"></stop>
                            </linearGradient>
                            <circle fill-rule="evenodd" clip-rule="evenodd" fill="url(#earth-gradient)" cx="49.5" cy="49.5" r="49.5"/>
                          ...
                          <span class="avatar__percent"><?php echo intval(0.28 * 100); ?>%</span>
                        ...
                        <span class="avatar__element avatar__element--active avatar__element--position_right">
                          <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 99 99">
                            <linearGradient id="fire-gradient" x1="0" y1="100%" x2="0" y2="0">
                              <stop offset="<?php echo intval(0.674 * 100); ?>%" stop-color="#551642"></stop>
                              <stop offset="<?php echo intval(0.674 * 100); ?>%" stop-color="#F9C778"></stop>
                            </linearGradient>
                            <circle fill-rule="evenodd" clip-rule="evenodd" fill="url(#fire-gradient)" cx="49.5" cy="49.5" r="49.5"/>
                        ...
                        <span class="avatar__element avatar__element--position_bottom">
                          <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 99 99">
                            <linearGradient id="air-gradient" x1="0" y1="100%" x2="0" y2="0">
                              <stop offset="<?php echo intval(0.12564 * 100); ?>%" stop-color="#551642"></stop>
                              <stop offset="<?php echo intval(0.12564 * 100); ?>%" stop-color="#F9C778"></stop>
                            </linearGradient>
                            <circle fill-rule="evenodd" clip-rule="evenodd" fill="url(#air-gradient)" cx="49.5" cy="49.5" r="49.5"/>
                        ...
                        <span class="avatar__element avatar__element--position_left">
                          <svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" viewBox="0 0 99 99">
                            <linearGradient id="water-gradient" x1="0" y1="100%" x2="0" y2="0">
                              <stop offset="<?php echo intval(0.97 * 100); ?>%" stop-color="#551642"></stop>
                              <stop offset="<?php echo intval(0.97 * 100); ?>%" stop-color="#F9C778"></stop>
                            </linearGradient>
                            <circle fill-rule="evenodd" clip-rule="evenodd" fill="url(#water-gradient)" cx="49.5" cy="49.5" r="49.5"/>
                ...
                <fieldset class="form">
                  <div class="edit__col">
                    <div class="form-group">
                      ...
                      <input id="edit-first-name" class="input" type="text" name="" value="Emma" placeholder="Click to insert text" />
                    </div>
                    <div class="form-group">
                      <label class="form-group__label" for="edit-last-name">Last name</label>
                      <input id="edit-last-name" class="input" type="text" name="" value="Rossi" placeholder="Click to insert text" />
                    </div>
                    <div class="form-group">
                      <div class="form__subgroup">
                        <label class="form-group__label">Gender</label>
                        <div>
                          <input id="male" class="none" type="radio" name="gender" value="" />
                          <label class="register__radio radio" for="male">Male</label>
                          <input id="female" class="none" type="radio" name="gender" value="" checked="checked" />
                      ...
                      <div class="form__subgroup">
                        ...
                        <div id="age" class="select js-select" data-eui-dropdown>
                          <div class="select__inner dd-eui-dropdown" data-eui-dropdown-depth="1">
                            <div class="select__value js-select-value">25</div>
                            <div class="select__items dd-eui-drop">
                              <?php for ($i = 18; $i < 100; $i += 1) { ?>
                                <input id="age-<?php echo $i; ?>" class="none js-select-option" type="radio" name="age" value="<?php echo $i; ?>" data-text="age-<?php echo $i; ?>" <?php if ($i === 25) { ?> checked="checked" <?php } ?> />
                                <label class="select__option" for="age-<?php echo $i; ?>"><?php echo $i; ?></label>
                              <?php } ?>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="form-group">
                      ...
                      <div id="country" class="select js-select" data-eui-dropdown>
                        <div class="select__inner dd-eui-dropdown" data-eui-dropdown-depth="1">
                          ...
                          <div class="select__items dd-eui-drop">
                            <?php for ($i = 18; $i < 100; $i += 1) { ?>
                              <input id="age-<?php echo $i; ?>" class="none js-select-option" type="radio" name="age" value="<?php echo $i; ?>" data-text="age-<?php echo $i; ?>" />
                              <label class="select__option" for="age-<?php echo $i; ?>"><?php echo $i; ?></label>
                            <?php } ?>
                          </div>
                        </div>
                    ...
                    <div class="form-group">
                      <label class="form-group__label" for="edit-email">Email / Pec</label>
                      <input id="edit-email" class="input" type="email" name="" value="emmarossi@gmail.com" placeholder="Click to insert text" />
                    </div>
                    <div class="form-group">
                      <label class="form-group__label" for="edit-phone">Phone <span class="form-group__addition">(optional)</span></label>
                      <input id="edit-phone" class="input" type="tel" name="" value="+39 334598763" placeholder="Click to insert text" />
                    </div>
                    <div class="form-group form-group--last register-socials">
                      ...
                      <div class="register-socials__row">
                        <input class="register-socials__input input input--with-icon" type="text" name="" value="" placeholder="Insert URL" />
                  ...
                  <div class="edit__col">
                    <div class="form-group">
                      ...
                      <div class="upload-avatar upload-avatar--active">
                        <div class="upload-avatar__container js-file-container">
                          <button class="upload-avatar__button js-upload-avatar-button js-upload-avatar-button--active" type="button">
                            <svg xmlns="http://www.w3.org/2000/svg" class="upload-avatar__icon upload-avatar__icon--add icon icon--middle js-upload-avatar-icon-add js-upload-avatar-icon--hidden" width="100" height="100" viewBox="0 0 100 100" fill="currentColor">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="upload-avatar__icon upload-avatar__icon--edit icon icon--middle js-upload-avatar-icon-edit" width="26" height="26" viewBox="0 0 53.4 53.4" fill="currentColor">
                              <path stroke-width="3.3737" stroke-linecap="round" stroke-miterlimit="10" d="M1.7,41.1v10.6h10.6l30.6-30.8L32.2,10.3L1.7,41.1z M50.9,12.8c1.1-1.1,1.1-2.8,0-3.9l-6.4-6.4 c-1.1-1.1-2.8-1.1-3.9,0l-5,5l10.6,10.6L50.9,12.8z"/>
                            </svg>
                            <img class="js-upload-avatar-image" src="./tmp_images/avatar.jpg" alt="" />
                          </button>
                          <input class="upload-avatar__trigger js-file" type="file" name="" value="" accept="image/jpeg,image/png" data-max-size="5000000" data-min-res="600:600" />
                    ...
                    <div class="form-group">
                      <label class="form-group__label" for="edit-about">About me:</label>
                      <textarea id="edit-about" class="input input--area" maxlength="140" placeholder="Write a small bio about you... (MAX 140 char.)">Lorem ipsum dolor sit amet, consectetur adipisci elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur.</textarea>
                    </div>
                    <div class="form-group form-group--last">
                      <div class="form__subgroup">
                        ...
                        <div id="remote-work" class="select js-select" data-eui-dropdown>
                          <div class="select__inner dd-eui-dropdown" data-eui-dropdown-depth="1">
                            <div class="select__value js-select-value">Lorem ipsum</div>
                            <div class="select__items dd-eui-drop">
                              <input id="remote-work-1" class="none js-select-option" type="radio" name="remote-work" value="Remote work 1" data-text="Remote work 1" />
                              <label class="select__option" for="remote-work-1">Remote work 1</label>
                              <input id="remote-work-2" class="none js-select-option" type="radio" name="remote-work" value="Remote work 2" data-text="Remote work 2" />
                              <label class="select__option" for="remote-work-2">Remote work 2</label>
                              <input id="remote-work-3" class="none js-select-option" type="radio" name="remote-work" value="Remote work 3" data-text="Remote work 3" />
                              <label class="select__option" for="remote-work-3">Remote work 3</label>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="form__subgroup">
                        ...
                        <div id="effort" class="select js-select" data-eui-dropdown>
                          <div class="select__inner dd-eui-dropdown" data-eui-dropdown-depth="1">
                            <div class="select__value js-select-value">Lorem ipsum</div>
                            <div class="select__items dd-eui-drop">
                              <input id="effort-1" class="none js-select-option" type="radio" name="effort" value="Effort 1" data-text="Effort 1" />
                              <label class="select__option" for="effort-1">Remote work 1</label>
                              <input id="effort-2" class="none js-select-option" type="radio" name="effort" value="Effort 2" data-text="Effort 2" />
                              <label class="select__option" for="effort-2">Remote work 2</label>
                              <input id="effort-3" class="none js-select-option" type="radio" name="effort" value="Effort 3" data-text="Effort 3" />
                              <label class="select__option" for="effort-3">Remote work 3</label>
                            </div>
                          </div>
                        </div>
                      </div>
        ...
        <a class="leave-feedback" href="#">Leave a feedback on your UTC</a>
      </main>
      ...
      <script src="./dist/js/profile-page.js"></script>
    </div>
  </body>
</html>
