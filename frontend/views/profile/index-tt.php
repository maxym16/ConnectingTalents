                                    ...
                                    var data = [
                                        {
                                            ...
                                            axes: [
                                                {axis: "Earth", value: <?= $utcdata->earth*1.2 + 1.12 ?>},
                                                {axis: "1", value: 1.11},
                                                {axis: "11", value: 1.11},
                                                {axis: "Water", value: <?= $utcdata->water*1.2 + 1.12 ?>},
                                                {axis: "2", value: 1.11},
                                                {axis: "22", value: 1.11},
                                                {axis: "Air", value: <?= $utcdata->air*1.2+1.12 ?>},
                                                {axis: "3", value: 1.11},
                                                {axis: "33", value: 1.11},
                                                {axis: "Fire", value: <?= $utcdata->fire*1.2 +1.12?>},
                                                {axis: "4", value: 1.11},
                                                {axis: "44", value: 1.11},
                                            ]
                                        }
