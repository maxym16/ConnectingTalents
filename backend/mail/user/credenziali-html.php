        ...
        <td>
            <div class="corpo" style="background-color:#fff;padding:50px;">                
                ...
                <div class="sezione titolo" style="overflow:hidden;color:#000000;">
                    <h2 style="padding:5px 0;	margin:0;"><?= $welcomeSwitch ?></h2>
                </div>
                <div class="sezione" style="overflow:hidden;color:#000000;">
                    <div class="testo">
                        ...
                        <p>
                            <?= Html::beginTag('a', ['href' => $appLink . 'site/insert-auth-data?token=' . $profile->user->password_reset_token, 'style' => 'color:#00742e; font-weight:bold;']) ?>
                        ...
                        <p>
                            ...
                            <span style="color:#00742e"><?= Yii::t('amosplatform', $appLink . 'site/insert-auth-data?token=' . $profile->user->password_reset_token) ?></span>
                        </p>
                    </div>
